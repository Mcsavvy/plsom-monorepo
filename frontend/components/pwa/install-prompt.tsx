...
export function PWAInstallPrompt({
  ...
  if (variant === "banner") {
    return (
      <div className="bg-primary text-primary-foreground fixed top-0 right-0 left-0 z-50 p-4 shadow-lg">
    ...
    return (
      <Card className="border-primary/20 bg-primary/5">
        ...
        <CardContent>
          ...
          {isIOS && (
            <div className="text-muted-foreground bg-muted mt-4 rounded-md p-3 text-sm">
