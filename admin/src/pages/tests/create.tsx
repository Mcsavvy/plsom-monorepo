...
import { QUESTION_TYPES, TestFormData } from '@/types/test';
...
const formSchema = z.object({
  ...
  course: z.number('Course is required'),
  cohort: z.number('Cohort is required'),
...
export const TestsCreate: React.FC = () => {
    ...
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground'>
          Create a comprehensive test with questions and assessments
        </p>
      </div>
