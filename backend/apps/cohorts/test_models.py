...
class CohortModelTestCase(TestCase):
    ...
    def test_cohort_ordering(self):
        ...
        self.assertEqual(cohorts[0], cohort2)  # Later start date should come first
    ...
    def test_clean_method_cannot_activate_ended_cohort(self):
        ...
        self.assertIn('Cannot activate a cohort that has already ended', str(context.exception))
    ...
    def test_can_be_deleted_started_cohort(self):
        ...
        self.assertFalse(can_delete)
        self.assertEqual(message, "Cannot delete cohort that has already started")
...
class EnrollmentModelTestCase(TestCase):
    ...
    def test_clean_method_end_date_after_enrollment(self):
        ...
        self.assertIn('End date must be after enrollment date', str(context.exception))
