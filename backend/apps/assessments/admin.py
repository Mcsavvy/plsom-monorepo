...
class TestAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Relationships", {"fields": ("course", "cohort", "created_by")}),
        (
            "Settings",
            {
                "fields": (
...
class SubmissionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("test", "student", "attempt_number", "status")}),
        (
            "Timing",
...
class AnswerAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("submission", "question", "is_flagged")}),
        (
            "Answer Content",
            {
                "fields": (
        ...
        (
            "Grading",
            {"fields": ("points_earned", "feedback"), "classes": ("collapse",)},
        ),
        (
            "Metadata",
            {
